...
public class TodosResource {
    ...
    // Allows to insert contextual objects into the class, e.g.
    ...
    // Use http://localhost:8080/lab2-context-root/rest/todos/count
    @GET
    @Path("count")
    ...
    // Use http://localhost:8080/lab2-context-root/rest/todos/1
